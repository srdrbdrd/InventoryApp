...
/**
 * Created by Serdar on 08.07.2018.
 */
...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, final Context context, Cursor cursor) {
        TextView nameView = view.findViewById(R.id.text_view_product);
        TextView priceView = view.findViewById(R.id.text_view_price);
        TextView quantityView = view.findViewById(R.id.text_view_quantity);
        ImageView shopImage = view.findViewById(R.id.reduce_button);
